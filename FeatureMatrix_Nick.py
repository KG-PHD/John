...
nSubjects_Nick = 1; # Number of time segments in AWW resting dataset
...
#data_Nick = pd.read_csv('Nick.csv')
print(data_Nick)
...
#NickAll_walk = np.concatenate([NickAll[x] for x in range(5)], 0)
#NickAll_rest = np.concatenate([NickAll[x] for x in range(5,11)], 0)

#NickAcc_walk = np.concatenate([NickAcc[x] for x in range(5)], 0)
#NickAcc_rest = np.concatenate([NickAcc[x] for x in range(5,11)], 0)

#NickEda_walk = np.concatenate([NickEda[x] for x in range(5)], 0)
#NickEda_rest = np.concatenate([NickEda[x] for x in range(5,11)], 0)

#NickLabels_walk = np.concatenate([NickLabels[x] for x in range(5)], 0)
#NickLabels_rest = np.concatenate([NickLabels[x] for x in range(5,11)], 0)

#NickGroups_walk = np.concatenate([NickGroups[x] for x in range(5)], 0)
#NickGroups_rest = np.concatenate([NickGroups[x] for x in range(5,11)], 0)